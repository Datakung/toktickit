...
| [Issue #16](https://github.com/Datakung/toktickit/issues/16) — `feature/16-quality-release` | Pending quality PR | Local release audit and evidence are complete; review discussion has not started. | Pending Phanuwit's review, approval, and reviewer-performed merge |
...
| [#16 — Quality and release integration](https://github.com/Datakung/toktickit/issues/16) | Started — local quality gate passed; PR review and release integration pending |
