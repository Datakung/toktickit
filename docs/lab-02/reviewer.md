...
| [Issue #16](https://github.com/Datakung/toktickit/issues/16) — `feature/16-quality-release` | [PR #22 — Lab 2 quality and release evidence](https://github.com/Datakung/toktickit/pull/22) | Local release audit and evidence are complete; review discussion has not started. | Pending Phanuwit's review, approval, and reviewer-performed merge |
