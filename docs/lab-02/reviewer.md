...
| [Issue #14](https://github.com/Datakung/toktickit/issues/14) — `feature/14-my-tickets` | Pending until the implementation commit is pushed | Pending | Pending |
...
All six Lab 2 Issues were created before implementation and initially placed in Backlog. Issues #11–#13 reached Done only after the required review conversation, Phanuwit's approval, and reviewer-performed merge. Issue #14 then moved through Specified to Started for implementation on its dedicated branch.
...
| [#14 — My Tickets](https://github.com/Datakung/toktickit/issues/14) | Started — implementation and local verification in progress |
