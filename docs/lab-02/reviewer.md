...
| [Issue #15](https://github.com/Datakung/toktickit/issues/15) — `feature/15-ticket-detail-attachments` | [PR #21 — Ticket Detail and Attachment lifecycle](https://github.com/Datakung/toktickit/pull/21) | Phanuwit [requested two contract corrections](https://github.com/Datakung/toktickit/pull/21#pullrequestreview-5078895790): central handling and regressions for `REQUESTER_UNAVAILABLE`, plus route-heading and modal focus management. Pitchai accepted both findings, returned the card to Fixing, centralized the requester reset, and added 403, focus-entry/trap, Escape, and trigger-restoration regressions. The correction commit and response are retained in PR #21's history. | Pending Phanuwit's re-review, approval, and reviewer-performed merge |
